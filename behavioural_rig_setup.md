...
7. Start the `.sln`
8. Click start on the panel to switch on the camera. 
...
11. Fill in the meta data about the experiment.
12. Open Stimuli server (this is to pair the shader with the project screen).
...
14.  Then Open sublime and look for a file with a command `move 505 143 403 1` (the number will be different for each set-up). Enter this command into the stimuli controller panel 
